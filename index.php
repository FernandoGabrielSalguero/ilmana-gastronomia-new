...
</html>SESSION[\'usuario_id\'] = $user[\'Id\'];
        <?php
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);
...
</html>SESSION[\'usuario\'] = $user[\'Usuario\'];
        <?php
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);
...
</html>SESSION[\'nombre\'] = $user[\'Nombre\'];
        <?php
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);
...
</html>SESSION[\'correo\'] = $user[\'Correo\'];
        <?php
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);
...
</html>SESSION[\'telefono\'] = $user[\'Telefono\'];
        <?php
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);
...
</html>SESSION[\'estado\'] = $user[\'Estado\'];
        <?php
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);
...
</html>SESSION[\'saldo\'] = $user[\'Saldo\'] ?? 0.00;
        <?php
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);
...
</html>SESSION[\'LAST_ACTIVITY\'] = time();
