...
<body>
        ...
        <div class="main">
            ...
            <section class="content">
                ...
                <div class="card" id="tutorial-intro">
                    ...
                    <br>
                    <button class="btn btn-info btn-small" type="button" id="tutorial-start-btn">Ver tutorial</button>
                </div>
    ...
    <script>
        ...
        function cargarModalVianda() {
            ...
            fetch(`papa_menu_view.php?${params.toString()}`, {
                ...
                .then(html => {
                    ...
                    if (typeof window.inicializarModalVianda === 'function') {
                        window.inicializarModalVianda();
                    }
                })
                .catch(() => {
                    body.innerHTML = '<p>Error al cargar el formulario.</p>';
        ...
        function inicializarModalVianda() {
