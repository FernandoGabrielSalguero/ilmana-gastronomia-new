...
require_once __DIR__ . '/../../controllers/admin_entregasColegiosController.php';
        ...
        <div class="resumen-modal-dialog" role="dialog" aria-modal="true" aria-labelledby="resumenModalTitle">
            <div class="resumen-modal-header">
                <div>
                    ...
                    <p class="resumen-modal-subtitle">Guia rapida para planificar entregas y cajas.</p>
                </div>
...
function renderDetallesPedidosTable($detallesPedidos)
{
    ?>
...
if (isset($_GET['ajax']) && $_GET['ajax'] === '1') {
    ...
    ob_start();
    renderDetallesPedidosTable($detallesPedidos);
    $detallesHtml = ob_get_clean();
...
<head>
    ...
    <style>
        ...
        .resumen-modal-list li.resumen-modal-menu {
            display: grid;
            align-items: stretch;
            gap: 6px;
            padding-bottom: 8px;
...
<body>
    ...
    <div class="layout">
        ...
        <div class="main">
            ...
            <header class="navbar">
                ...
                <div class="navbar-title">Colegio</div>
            </header>
            ...
            <section class="content">
                    ...
                    <div class="resumen-header">
                        ...
                        <div class="resumen-actions">
                            ...
                            <div class="resumen-panel" id="panelViandasFiltros">
                                <form class="form-modern" method="get" action="admin_entregasColegios.php" id="viandas-filtros-form">
                                    ...
                                    <div class="form-buttons">
                                        ...
                                        <a class="btn btn-cancelar" href="admin_entregasColegios.php">Limpiar</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div id="detalles-pedidos-table">
                        <?php renderDetallesPedidosTable($detallesPedidos); ?>
                    </div>
                </div>
    ...
    <script>
        ...
        const detallesPedidosTable = document.getElementById('detalles-pedidos-table');
        ...
        const cargarViandasAjax = (fecha) => {
            ...
            fetch(`admin_entregasColegios.php?${params.toString()}`, {
                headers: {
                ...
                .then((data) => {
                    ...
                    if (detallesPedidosTable && typeof data.detallesHtml === 'string') {
                        detallesPedidosTable.innerHTML = data.detallesHtml;
                    }
