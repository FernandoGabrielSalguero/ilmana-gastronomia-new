<?php
require_once __DIR__ . '/../../controllers/admin_cuyoController.php';
?>
    ...
    <div class="layout">
        ...
        <div class="main">
            ...
            <header class="navbar">
                ...
                <div class="navbar-title">Cuyo Placas</div>
            </header>
                    ...
                    <div class="resumen-header">
                        ...
                        <div class="resumen-actions">
                            ...
                            <div class="filtros-panel" id="panelFiltros">
                                <form class="form-modern" method="get" action="admin_cuyoPlacas.php">
                                    ...
                                    <div class="form-buttons">
                                        ...
                                        <a class="btn btn-cancelar" href="admin_cuyoPlacas.php">Limpiar</a>
                                    </div>
                                </form>
                            </div>
                        </div>
